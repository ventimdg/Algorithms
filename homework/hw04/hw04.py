...
def has_path(t, word):
    ...
    def helper(t, word, answer = label(t)): 
        if answer == word:
            return True
        else:
            return True in [helper(b, word, answer + label(b)) for b in branches(t)]
...
def preorder(t):
    ...
    """print("DEBUG:", label(t))
    return [preorder(b) for b in branches(t)]"""
    
    
    
    """def helper(t, answer = label(t)): 
        print("DEBUG:", answer)
        return [helper(b, label(b)) for b in branches(t)]
    return helper(t)"""
